...
// Dados oficiais base (atualização PROCON)
...
window.PlantoesStore = {
  get() {
    ...
    // Caso seja a primeira vez usando
    if (!raw) {
    ...
    try {
      ...
      console.warn("⚠ Erro ao carregar dados do localStorage. Resetando base.");
      return dadosPlantoesBase;
    }
  },

  set(list) {
    localStorage.setItem(PLANTOES_STORAGE_KEY, JSON.stringify(list));
  },
